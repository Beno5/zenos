 ...
 !(function (e, t, n) {
  ...
  function c(e, n, r, o) {
      ...
      return (
          ...
          (d.id = f),
          p.fake && ((p.style.background = ""), (p.style.overflow = "hidden"), (u = E.style.overflow), (E.style.overflow = "hidden"), E.appendChild(p)),
          (i = n(d, e)),
          p.fake ? (p.parentNode.removeChild(p), (E.style.overflow = u), E.offsetHeight) : d.parentNode.removeChild(d),
          !!i
      );
  }
  function u(e, t) {
